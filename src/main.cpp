...
int main()
{
    ...
    cv::createTrackbar("Size", "Control", &structuring_element_size, 10); //Value (0 - 10)
    cv::createTrackbar("Operation", "Control", &structuring_element_operation, 1); //Value (0 - 1)
    ...
    for(;;) {
        ...
        // Rotate the frame using OpenCV
        cv::rotate(frame_bgr, frame_bgr, cv::ROTATE_180);
